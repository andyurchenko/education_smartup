...
public class DtoClientResponse {
    ...
    public DtoClientResponse(long id, String firstName, String lastName, String patronymic, String email, String phone, UserType userType) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DtoClientResponse that)) return false;
